...
function CodeTable({ dark, activeSlot }) {
  return (
    <Card className="w-fit p-4 sm:p-5">
  ...
  return (
    <div>
      ...
      <Reveal className="@container">
        <div className="mt-8 grid items-start gap-x-12 gap-y-9 @4xl:mt-10 @4xl:grid-cols-[0.92fr_1.08fr]">
          <div>
      ...
      <Reveal className="@container">
        <div className="mt-10 grid items-center gap-x-12 gap-y-10 @4xl:mt-16 @4xl:grid-cols-[0.82fr_1.18fr]">
      ...
      <Reveal className="@container">
        <div className="mt-10 grid items-center gap-x-12 gap-y-9 @4xl:mt-16 @4xl:grid-cols-[0.92fr_1.08fr]">
              ...
              {rows.slice(0, 12).map((s) => {
                ...
                return (
                  <div key={s.id} className="flex items-center gap-3 py-2.5 text-[12px]">
                    <span className="cl-mono shrink-0 whitespace-nowrap text-[11px] text-zinc-400 dark:text-zinc-500">{s.id.slice(0, -4)}<span className="font-bold" style={{ color: ink }}>{s.id.slice(-4)}</span></span>
