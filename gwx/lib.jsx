/* gwx/lib.jsx — shared design system (extracted from claude5iq's lib.jsx,
 * re-fitted for the catalyst chrome — same lineage as the statusbar,
 * horse-browser, and claude-md modules' libs).
 *
...
// account dot colours — deliberately NO green and NO red (those read as a
// good/bad status, not an identity).
...
/* ───────────────────────── injected stylesheet ────────────────────────────── */
const STYLE_ID = 'gwx-module-styles'
const CSS = `
...
@keyframes cl-beacon{ 0%{ box-shadow:0 0 0 0 var(--bc, rgba(245,158,11,.5)); } 70%,100%{ box-shadow:0 0 0 12px transparent; } }
...
@media (prefers-reduced-motion: reduce){
  ...
  .cl-pop,.cl-fadein,.cl-beacon{ animation:none !important; }
...
// fresh install from the source of truth, never a kept copy).
